...
The unit cell data used in this study are based on entries from the Inorganic Crystal Structure Database (ICSD) (https://icsd.products.fiz-karlsruhe.de/) database:

- ICSD #136042: Cu   (cubic)       'F m -3 m'    space group IT number: 225,  crystal name used in codes 'Cu_fcc'
- ICSD #63281:  Cu2O (cubic)       'P n -3 m Z'  space group IT number: 224,  crystal name used in codes 'Cu_cubic'
- ICSD #67850:  CuO  (monoclinic)  'C 1 2/c 1'   space group IT number: 15,   crystal name used in codes 'CuO_monoclinic'
