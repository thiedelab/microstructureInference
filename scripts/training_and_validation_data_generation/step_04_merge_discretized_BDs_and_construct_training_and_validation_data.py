...
file_path = "/projects/bdts/jekw/projects/py4DSTEM_table/complete_new_approach/"

input_0 = "list_of_Bragg_disks_total_0.npy"
input_1 = "list_of_Bragg_disks_total_1.npy"
input_2 = "list_of_Bragg_disks_total_2.npy"
input_3 = "list_of_Bragg_disks_total_3.npy"
input_4 = "list_of_Bragg_disks_total_4.npy"
input_5 = "list_of_Bragg_disks_total_5.npy"
input_6 = "list_of_Bragg_disks_total_6.npy"
input_7 = "list_of_Bragg_disks_total_7.npy"
input_8 = "list_of_Bragg_disks_total_8.npy"
input_9 = "list_of_Bragg_disks_total_9.npy"
input_10 = "list_of_Bragg_disks_total_10.npy"
input_11 = "list_of_Bragg_disks_total_11.npy"
input_12 = "list_of_Bragg_disks_total_12.npy"
input_13 = "list_of_Bragg_disks_total_13.npy"
input_14 = "list_of_Bragg_disks_total_14.npy"
input_15 = "list_of_Bragg_disks_total_15.npy"
input_16 = "list_of_Bragg_disks_total_16.npy"
input_17 = "list_of_Bragg_disks_total_17.npy"
input_18 = "list_of_Bragg_disks_total_18.npy"
input_19 = "list_of_Bragg_disks_total_19.npy"
...
np.save(file_path + "entire_Bradd_disks_padded_train.npy", list_of_Bragg_disks_padded_train)
np.save(file_path + "entire_Bradd_disks_padded_valid.npy", list_of_Bragg_disks_padded_valid)
...
orientation_canonical_0 = "orientation_canonical_0.npy"
orientation_canonical_1 = "orientation_canonical_1.npy"
orientation_canonical_2 = "orientation_canonical_2.npy"
orientation_canonical_3 = "orientation_canonical_3.npy"
orientation_canonical_4 = "orientation_canonical_4.npy"
orientation_canonical_5 = "orientation_canonical_5.npy"
orientation_canonical_6 = "orientation_canonical_6.npy"
orientation_canonical_7 = "orientation_canonical_7.npy"
orientation_canonical_8 = "orientation_canonical_8.npy"
orientation_canonical_9 = "orientation_canonical_9.npy"
orientation_canonical_10 = "orientation_canonical_10.npy"
orientation_canonical_11 = "orientation_canonical_11.npy"
orientation_canonical_12 = "orientation_canonical_12.npy"
orientation_canonical_13 = "orientation_canonical_13.npy"
orientation_canonical_14 = "orientation_canonical_14.npy"
orientation_canonical_15 = "orientation_canonical_15.npy"
orientation_canonical_16 = "orientation_canonical_16.npy"
orientation_canonical_17 = "orientation_canonical_17.npy"
orientation_canonical_18 = "orientation_canonical_18.npy"
orientation_canonical_19 = "orientation_canonical_19.npy"
...
np.save(file_path + "orientation_canonical_labels_train.npy", orientation_canonical_labels_train)
np.save(file_path + "orientation_canonical_labels_valid.npy", orientation_canonical_labels_valid)

del orientation_canonical_label_stacked
del orientation_canonical_labels_train
del orientation_canonical_labels_valid

orientation_original_0 = "orientation_original_0.npy"
orientation_original_1 = "orientation_original_1.npy"
orientation_original_2 = "orientation_original_2.npy"
orientation_original_3 = "orientation_original_3.npy"
orientation_original_4 = "orientation_original_4.npy"
orientation_original_5 = "orientation_original_5.npy"
orientation_original_6 = "orientation_original_6.npy"
orientation_original_7 = "orientation_original_7.npy"
orientation_original_8 = "orientation_original_8.npy"
orientation_original_9 = "orientation_original_9.npy"
orientation_original_10 = "orientation_original_10.npy"
orientation_original_11 = "orientation_original_11.npy"
orientation_original_12 = "orientation_original_12.npy"
orientation_original_13 = "orientation_original_13.npy"
orientation_original_14 = "orientation_original_14.npy"
orientation_original_15 = "orientation_original_15.npy"
orientation_original_16 = "orientation_original_16.npy"
orientation_original_17 = "orientation_original_17.npy"
orientation_original_18 = "orientation_original_18.npy"
orientation_original_19 = "orientation_original_19.npy"
...
np.save(file_path + "orientation_original_labels_train.npy", orientation_original_labels_train)
np.save(file_path + "orientation_original_labels_valid.npy", orientation_original_labels_valid)
...
mirror_0 = np.load(file_path + "mirror_0.npy")
mirror_1 = np.load(file_path + "mirror_1.npy")
mirror_2 = np.load(file_path + "mirror_2.npy")
mirror_3 = np.load(file_path + "mirror_3.npy")
mirror_4 = np.load(file_path + "mirror_4.npy")
mirror_5 = np.load(file_path + "mirror_5.npy")
mirror_6 = np.load(file_path + "mirror_6.npy")
mirror_7 = np.load(file_path + "mirror_7.npy")
mirror_8 = np.load(file_path + "mirror_8.npy")
mirror_9 = np.load(file_path + "mirror_9.npy")

mirror_10 = np.load(file_path + "mirror_10.npy")
mirror_11 = np.load(file_path + "mirror_11.npy")
mirror_12 = np.load(file_path + "mirror_12.npy")
mirror_13 = np.load(file_path + "mirror_13.npy")
mirror_14 = np.load(file_path + "mirror_14.npy")
mirror_15 = np.load(file_path + "mirror_15.npy")
mirror_16 = np.load(file_path + "mirror_16.npy")
mirror_17 = np.load(file_path + "mirror_17.npy")
mirror_18 = np.load(file_path + "mirror_18.npy")
mirror_19 = np.load(file_path + "mirror_19.npy")
...
np.save(file_path + "entire_mirror_train.npy", mirror_train)
np.save(file_path + "entire_mirror_valid.npy", mirror_valid)



thickness_0 = np.load(file_path + "thickness_0.npy")
thickness_1 = np.load(file_path + "thickness_1.npy")
thickness_2 = np.load(file_path + "thickness_2.npy")
thickness_3 = np.load(file_path + "thickness_3.npy")
thickness_4 = np.load(file_path + "thickness_4.npy")
thickness_5 = np.load(file_path + "thickness_5.npy")
thickness_6 = np.load(file_path + "thickness_6.npy")
thickness_7 = np.load(file_path + "thickness_7.npy")
thickness_8 = np.load(file_path + "thickness_8.npy")
thickness_9 = np.load(file_path + "thickness_9.npy")

thickness_10 = np.load(file_path + "thickness_10.npy")
thickness_11 = np.load(file_path + "thickness_11.npy")
thickness_12 = np.load(file_path + "thickness_12.npy")
thickness_13 = np.load(file_path + "thickness_13.npy")
thickness_14 = np.load(file_path + "thickness_14.npy")
thickness_15 = np.load(file_path + "thickness_15.npy")
thickness_16 = np.load(file_path + "thickness_16.npy")
thickness_17 = np.load(file_path + "thickness_17.npy")
thickness_18 = np.load(file_path + "thickness_18.npy")
thickness_19 = np.load(file_path + "thickness_19.npy")
...
np.save(file_path + "entire_thickness_train.npy", thickness_train)
np.save(file_path + "entire_thickness_valid.npy", thickness_valid)





np.save(file_path + "entire_permuted_indices.npy", permuted_indices_total)
