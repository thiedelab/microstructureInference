...
with open(file_path + 'orientations_thickness_and_isMirrorSymmetry_for_data_generation_Cu_fcc_4e3_ee0.04.pkl', 'rb') as f:
    deploy_orientations_thickness_and_isMirrorSymmetry_for_data_generation = pickle.load(f)

zone_axes = np.load(file_path + "zone_axes_out_of_plane_displacement_2_degree.npy")
...
filename = "py4DSTEM_Cu_ori_table_normalize_by_maxInt_4e3_sg0.040_merged_%d"%(save_string)
