...
echo "Make sure bash files are executable"
echo "chmod +x STEP_01_sample_orientation_thickness.sh STEP_02_simulate_dynamic_diffraction.sh STEP_03_digitize_dynamic_diffraction.sh STEP_04_merge_and_split.sh"
