...
EXEC_SCRIPT="${BASE_DIR}/computeTime_new_2026/CPU_predict_orientationMap_synthetic_4DSTEM_via_model.py"
INPUT_FILE_PATH="${BASE_DIR}/sampled_and_stacked/fourD_braggVectors_pointLists/"
OUTPUT_FILE_PATH="${BASE_DIR}/computeTime_new_2026/output_SD${SCAN_DIM}_ID${STARTID}-${ENDID}_CPU/"
RESULT_DIR="${BASE_DIR}/computeTime_new_2026/timing_log_SD${SCAN_DIM}_ID${STARTID}-${ENDID}_CPU"
