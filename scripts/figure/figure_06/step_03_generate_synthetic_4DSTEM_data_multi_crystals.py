...
def parse_args():
    ...
    parser.add_argument("--thickness_angstrom", type = float, help="thickness value for bloch electron diffraction simulation", default = float(21.71))
...
def main():
    ...
    BraggDisks_list_file_name_str = "bragg_disks_corThForK80000_dog_sig1_2.00_sig2_6.00_cortThForTemp_4000"
    rotMat_file_path = "./"
    ...
    thickness = args.thickness_angstrom
    ...
    DP_Bragg_Disk_table_cartesian_for_each_crystal = []
    ...
    for crystal_idx, crystal_name in enumerate(list_of_crystal_names):
        ...
        DPs_collection, labels_collection, thickness_sampled, DP_Bragg_Disk_table_cartesian = sample_diffraction_patterns_from_rotation_matrices(
                                                                crystal, 
        ...
        DP_Bragg_Disk_table_cartesian_for_each_crystal.append(DP_Bragg_Disk_table_cartesian)
    ...
    for i in range(syn_2D_scanSpace_map.shape[0]):
            ...
            if grain_index > 0:
                ...
                for crystal_idx, assigned_grain_indices_for_a_crystal in enumerate(grain_indices_for_each_crystal):
                    ...
                    if len(index_where_grain_index_is_located) > 0:
                        ...
                        DP_Bragg_Disk_table_cartesian_collection = DP_Bragg_Disk_table_cartesian_for_each_crystal[crystal_idx]
                        ...
                        DP_Bragg_Disk_table_cartesian = DP_Bragg_Disk_table_cartesian_collection[index_where_grain_index_is_located[0]]
                        ...
                        row_DP_Bragg_Disk_table_cartesian.append(DP_Bragg_Disk_table_cartesian)
                ...
                row_DP_Bragg_Disk_table_cartesian.append(np.zeros((max_sequence_length,3)))
                # print("synthetic_diffraction_pattern.shape", synthetic_diffraction_pattern.shape)
        ...
        total_DP_Bragg_Disk_table_cartesian_for_each_crystal.append(row_DP_Bragg_Disk_table_cartesian)
    ...
    total_DP_Bragg_Disk_table_cartesian_for_each_crystal = np.array(total_DP_Bragg_Disk_table_cartesian_for_each_crystal)
    np.save("multi_crystal_synthetic_4DSTEM_data_DP_Bragg_Disk_table_cartesian.npy", total_DP_Bragg_Disk_table_cartesian_for_each_crystal)
