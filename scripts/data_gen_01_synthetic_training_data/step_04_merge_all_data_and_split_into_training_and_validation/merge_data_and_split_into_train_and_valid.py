...
np.save("entire_Bradd_disks_padded_train.npy", list_of_Bragg_disks_padded_train)
np.save("entire_Bradd_disks_padded_valid.npy", list_of_Bragg_disks_padded_valid)
...
np.save("orientation_canonical_labels_train.npy", orientation_canonical_labels_train)
np.save("orientation_canonical_labels_valid.npy", orientation_canonical_labels_valid)
...
np.save("orientation_original_labels_train.npy", orientation_original_labels_train)
np.save("orientation_original_labels_valid.npy", orientation_original_labels_valid)
...
np.save("entire_mirror_train.npy", mirror_train)
np.save("entire_mirror_valid.npy", mirror_valid)
...
np.save("entire_thickness_train.npy", thickness_train)
np.save("entire_thickness_valid.npy", thickness_valid)





np.save("entire_permuted_indices.npy", permuted_indices_total)
