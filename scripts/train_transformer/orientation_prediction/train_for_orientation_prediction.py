...
def main():
    ...
    if initial_run == True:
        ...
        checkpoint_path = model_path + 'last_updated_model.pth'
    ...
    train_error = np.save(output_path + "train_error.npy", np.array(train_error))
    valid_error = np.save(output_path + "valid_error.npy", np.array(valid_error))
